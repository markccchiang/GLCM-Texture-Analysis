...
// hole belongs to that region. Regions with fewer than min_pixels pixels, holes included, are left out.
// Throws std::invalid_argument for another image type, min_value > max_value, min_pixels < 1 or max_regions < 0.
