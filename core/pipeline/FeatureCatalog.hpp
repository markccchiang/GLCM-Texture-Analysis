...
enum class FeatureGroup { RegionStatistics, Haralick, Other, RunLength, SizeZone, GrayToneDifference };
...
// "regionStatistics", "haralick", "other", "runLength", "sizeZone" or "grayToneDifference"
