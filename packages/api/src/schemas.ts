...
export const FeatureGroup = Type.Union([Type.Literal('regionStatistics'), Type.Literal('haralick'), Type.Literal('other'), Type.Literal('runLength'), Type.Literal('sizeZone')]);
